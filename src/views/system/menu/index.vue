  ...
  <div class="app-container">
    ...
    >
      <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="80px">
        ...
        <el-form-item v-show="form.type!== 'BUTTON'" label="菜单图标" prop="icon">
          <el-popover
        ...
        <el-form-item v-show="form.type === 'BUTTON'" label="按钮名称" prop="name">
          <el-input v-model="form.name" placeholder="按钮名称" style="width: 178px;" />
        </el-form-item>
        <el-form-item v-show="form.type !== 'CATALOGUE'" label="权限标识" prop="permission">
        ...
        <el-form-item v-show="!form.iframe && form.type === 'MENU'" label="组件名称" prop="componentName">
          <el-input v-model="form.componentName" style="width: 178px;" placeholder="匹配组件内Name字段" />
        </el-form-item>
        <el-form-item v-show="!form.iframe && form.type === 'MENU'" label="组件路径" prop="component">
...
// crud交由presenter持有
const defaultCrud = CRUD({ title: '菜单', url: '/system/menu', crudMethod: { ...crudMenu }})
const defaultForm = {
  id: null, name: null, sort: 999, path: null,
  component: null, componentName: null, iframe: false, roles: [],
  pid: 0, icon: null, cache: false, hidden: false, type: 'CATALOGUE', permission: null
}
